...
jokes = ["Just recently ended a 5 year relationship. It's OK though, it wasn’t my relationship.", "Yo mama is like a bowling ball. She gets picked up, fingered, thrown away, and she keeps coming back for more!", "Went to the barbers today and asked to get my hair cut like Justin Bieber. He totally shaved my head bald. I said 'What the hell have you done. Justin Bieber doesn't have his hair cut like this!!', the barber said 'He would if he came into my shop.'", "Just named my new kid cancer. That way when people hear about me beating cancer it'll make me sound better.", "Have you heard about the new aftershave the Catholic Church have just released?", "It's called 'Eau My God'.", "I used to work as a mechanic fixing jet-ski engines at my local Sea World Center but I got fired after blowing a seal.", "Don't you just hate it when your Korean grandma makes a really nice chow-mein but then you find out your dogs gone missing.", "I wish I were a unicorn…. so I could stab idiots with my head.", "Had a great time watching Fifty Shades Of Grey at the cinema with my girlfriend. The film was terrible but the reaction of the people sitting in front of us after I flicked mayonnaise on them was hilarious.", "If Steve has 20 dollars and Tyrone takes 16, what color is Tyrone?", "Two years ago I asked the girl of my dreams on a date, today I asked her to marry me. She said no, on both occasions.", "Recently had a great money saving idea. Instead of paying for teeth whitening I've decided to get a sun-tan instead. ", "I used to be a gynecologist but I had to quit due to health reasons. I kept getting tunnel vision.", "Got a valentines card from my Grandma earlier today which was sweet but unnecessary, we haven't had sex in years.", "People always ask me why I'm single. I'm single by choice… unfortunately it's not my choice", "Have you heard about this new thing you can have that transfers the thoughts and memories of one person to another person. It's called a CONVERSATION.", "Yo mama is so harry big foot took a picture of her.", "Just been sacked from my job at the casino. Apparently when they hired me as a dealer I wasn't supposed to try and sell crack cocaine to customers.", "Did you hear about the Irish metal detector enthusiast who dug a hole 70ft deep? It turns out he had steel toecap shoes on."]
